...
class Config:
    ...
    # Flask settings
    SECRET_KEY = os.getenv("AUTH_APP_SECRET", "dev-secret-key-change-in-production")
    ...
    POSTGRES_DB = os.getenv("AUTH_DB", "auth_db")
    ...
    # JWT settings
    JWT_SECRET_KEY = os.getenv("AUTH_JWT_SECRET", "jwt-secret-key-change-in-production")
