...
export OSH='/c/Users/nhdinh/.oh-my-bash'
...
alias dcup="docker compose -f docker-compose.yml -f docker-compose.reload.yml up -d "
alias dcrs="docker compose -f docker-compose.yml -f docker-compose.reload.yml restart "

function tail_log { docker compose logs "$1" | tail -$2; }
